        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-center mb-12">
                <div className="w-full md:w-1/2 text-center md:text-left">
                    <p className="text-lg mb-4">Welcome to our e-commerce store! We are dedicated to providing
                    best products and services to our customers. Our mission is to a 
                    seamless shopping experience while ensuring the highest quality
                    our offerings</p>
                </div>
