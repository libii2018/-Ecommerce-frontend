...
const Navbar = () => {
    ...
    return (
        <div className="h-[70px] bg-blue-800 text-white z-50 flex items-center sticky top-0">
            <div className="lg:px-14 sm:px-8 px-4 w-full flex justify-between">
                ...
                } transition-all duration-100 sm:h-fit sm:bg-none bg-blue-800 text-white sm:w-fit w-full sm:flex-row flex-col px-4 sm:px-0`}>
